...
var TaskWhere = struct {
	...
	SessionID:   whereHelperstring{field: "\"tasks\".\"session_id\""},
	CompletedAt: whereHelpernull_Time{field: "\"tasks\".\"completed_at\""},
...
var (
	taskAllColumns            = []string{"id", "title", "session_id", "completed_at", "created_at", "updated_at"}
	taskColumnsWithoutDefault = []string{"id", "title", "session_id", "completed_at", "updated_at"}
	taskColumnsWithDefault    = []string{"created_at"}
...
func (o *Task) Session(mods ...qm.QueryMod) sessionQuery {
...
func (taskL) LoadSession(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	var slice []*Task
	var object *Task
...
// Sets o.R.Session to related.
// Adds o to related.R.Tasks.
func (o *Task) SetSession(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Session) error {
	var err error
	if insert {
...
func (o *Task) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert tasks")
	}
